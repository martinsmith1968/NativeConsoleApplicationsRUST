...
fn default_banner(texts: &[&str]) -> String {
    generate_banner(texts, '*', 1, '*', 1, '*', 2, 2, 2, 2, TextAlignment::Left, 0, 0)
}
...
fn test_multi_text_second_longer() {
    ...
    assert!(lines[1].starts_with("**  Hi"), "First line should start with '**  Hi'");
...
fn test_multi_text_first_longer() {
    ...
    assert!(lines[2].starts_with("**  Hi"), "Second line should start with '**  Hi'");
    assert_eq!(lines[3], "*************");
}
...
fn test_multi_text_three_texts() {
    ...
    assert!(lines[1].starts_with("**  A"), "First text line should start with '**  A'");
    assert!(lines[2].starts_with("**  BB"), "Second text line should start with '**  BB'");
